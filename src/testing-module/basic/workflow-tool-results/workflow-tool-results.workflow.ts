import { CreateChatMessage, CreateValue, WorkflowBase } from '@loopstack/core';
import { BlockConfig, Helper, Tool } from '@loopstack/common';
import { Injectable } from '@nestjs/common';
import {
  WorkflowMetadataInterface
} from '@loopstack/core/dist/workflow-processor/interfaces/workflow-metadata.interface';
